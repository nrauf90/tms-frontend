...
import RecentRegisteredCompaniesTable from '../tables/RecentRegisteredCompaniesTable'
import RecentSubscriptionsTable from '../tables/RecentSubscriptionsTable'
  ...
  return (
    <Grid container spacing={6}>
      <Grid item xs={12} sm={3}>
        ...
        <Grid item xs={12} sm={3}>
          ...
          sx={{ 
            ...
            avatarIcon='clarity:license-line'
          />
        </Grid>
        <Grid item xs={12} sm={3}>
          <CardStatsVertical
        ...
        {/* <Grid item xs={12} sm={2.3}>
          <CardStatsVertical
            ...
            avatarIcon='fluent-mdl2:packages'
          />
        </Grid> */}
      ...
      <CardContent sx={{ '& .MuiTabPanel-root': { p: 0 } }}>
        ...
        <Grid item xs={12}>
              <Card>
              <CardHeader title='Recent Registered Companies' />
              <RecentRegisteredCompaniesTable />
              </Card>
        </Grid>
        <Grid item xs={12}>
              <Card>
        ...
        <Grid item xs={12}>
              <Card>
              <CardHeader title='Recent License Expired Companies' />
              <RecentSubscriptionsTable />
              </Card>
        </Grid>
      </Grid>
